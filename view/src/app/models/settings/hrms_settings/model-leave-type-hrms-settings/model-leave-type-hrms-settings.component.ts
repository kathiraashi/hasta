...
@Component({
  selector: 'app-model-leave-type-hrms-settings',
  templateUrl: './model-leave-type-hrms-settings.component.html',
  styleUrls: ['./model-leave-type-hrms-settings.component.css']
})
      ...
      if (this.Form.valid && !this.Uploading) {
         ...
         this.Service.Leave_Type_Create({'Info': Info}).subscribe( response => {
            ...
            if (response['status'] === 200 && ReceivingData.Status) {
               ...
               this.Toastr.NewToastrMessage(  { Type: 'Success', Message: 'Leave Type Successfully Created' });
